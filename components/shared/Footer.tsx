        ...
        <div className="!mt-4 flex flex-col md:flex-row md:gap-0 justify-between">
          <div className="w-full md:w-[32%]">
            ...
            <p className="mt-9 text-white text-sm font-medium">
              First Call Real Estate specializes in off-plan properties and
              ...
              investment journey. Discover exceptional properties and unlock
              your real estate potential with us!
            </p>
          </div>
            ...
            <div className="w-full flex flex-col gap-5">
              ...
              <div className="flex gap-4">
                ...
                <p className="text-white text-sm ">
                  2107 Iris Bay, Business Bay, <br />
                  Dubai, UAE
                </p>
              </div>
              <div className="flex gap-4">
                <Phone size={16} color="#fff" />
                <p className="text-white text-sm">+971 5 5730 3207</p>
              </div>
            ...
            <div className="flex items-center gap-[14px]">
              {socialLinks.map((link, idx: number) => (
                <Link
                  ...
                  href={link.link}
                  target="_blank"
                  className="h-[30px] cursor-pointer hoverActiveScale2 w-[30px] border border-white rounded-full flex items-center justify-center"
                >
