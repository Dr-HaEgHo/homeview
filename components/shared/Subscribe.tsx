  ...
  return (
    <div className=' w-full flex items-center mt-3'>
     <form className='w-full flex items-center gap-4' action="submit">
       <input value={email} type='email' onChange={(e: ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)} className='bg-white h-[54px] flex flex-[1] rounded-[6px] text-[#8b8b8b] py-[18px] px-[14px]' />
