...
export const propertyTypes = [
  {name: "Apartments",  filter: "apartment", image: apartment, count: 57},
  {name: "Villas",  filter: "villa", image: villa, count: 32},
  {name: "Town House",  filter: "townhouse", image: townhouse, count: 14},
  {name: "Commercial",  filter: "commercial", image: commercial, count: 20},
]

export const whychoose = [
  {title: "Trusted by Thousands", description: "Our reputation is built on trust, with thousands of satisfied clients who have chosen us for their real estate needs.", filter: "apartment", image: trust, },
  {title: "Premium Properties", description: "Explore a diverse selection of properties, from luxury homes to commercial spaces, tailored to fit every preference", filter: "villa", image: building, },
  {title: "Financing Made Easy", description: "Simplified financing solutions and flexible options to help you secure your dream property without the hassle.", filter: "townhouse", image: calc, },
  {title: "Prime Locations", description: "Access the best neighborhoods and thriving communities with unmatched investment opportunities.", filter: "commercial", image: map, },
]
...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "Our indicators cover Dubai and other major UAE real estate markets.",
  },
];
...
export const newsItems = [
  {
    ...
    content: "Dubai's real estate sector is poised for exceptional growth in 2025, with new developments and foreign investment driving unprecedented demand. Industry experts predict a 15% increase in property values across key areas.",
    date: "Sep 12 2025"
  },
  {
    id: 1,
  ...
  },
  {
    id: 6,
    image: b2,
    title: "Unlocking Success Episode 16: Why Adrian Chabada left and came back to host & host",
    content: "Dubai's real estate sector is poised for exceptional growth in 2025, with new developments and foreign investment driving unprecedented demand. Industry experts predict a 15% increase in property values across key areas.",
    date: "Aug 27 2025"
  },
  {
